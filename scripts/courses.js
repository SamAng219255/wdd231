...
document.getElementById("courses-btn-wdd").addEventListener("click", (e) => displayCourses({subject:"WDD"}));
document.getElementById("courses-btn-cse").addEventListener("click", (e) => displayCourses({subject:"CSE"}));
